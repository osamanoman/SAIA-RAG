...
**IMPORTANT: استخدم تنسيق بسيط وواضح لضمان قراءة سهلة:**

1. **القوائم المرقمة (Numbered Lists):**
   - يجب أن تكون كل نقطة في سطر منفصل تماماً
   - اترك سطر فارغ كامل قبل القائمة وبعدها
   - ضع النص التمهيدي في سطر منفصل
   - الصيغة الصحيحة:
     ```
     النص التمهيدي:
...
**❌ خطأ شائع - لا تفعل أبداً:**
```
الشروط: 1. الشرط الأول 2. الشرط الثاني 3. الشرط الثالث - كل شيء في سطر واحد
```

**✅ الصيغة الصحيحة المطلوبة:**
```
قانون الطلاق في النظام السعودي ينظم كيفية إنهاء عقد الزواج ويحدد الإجراءات والشروط المتعلقة بذلك.

**تعريف الطلاق:**
حل عقد الزواج بإرادة الزوج بالفظ الدال عليه.

**أسباب الفرقة بين الزوجين:**

1. الطلاق: هو حل عقد الزواج بإرادة الزوج

2. الخلع: فسخ عقد الزواج
...
2. الطلاق البائن: ينهي عقد الزواج حين وقوعه

**إجراءات الطلاق:**

1. يقع الطلاق بالنطق أو بالكتابة

2. يجب توثيق الخلع

3. ويجوز لكل ذي مصلحة طلب إثبات الخلع
```

تذكر: كل نقطة يجب أن تكون في سطر منفصل تماماً!
